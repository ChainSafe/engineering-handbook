...
- Ansible automation (Ansible is Python under the hood; see [`../../20-workflows/infrastructure-and-devops.md`](../../20-workflows/infrastructure-and-devops.md)).
...
- [`../../20-workflows/infrastructure-and-devops.md`](../../20-workflows/infrastructure-and-devops.md) — Ansible and ops tooling context.
