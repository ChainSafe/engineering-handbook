...
Language-specific checklist when reviewing a Rust PR. Operates under the [universal review principles](../../20-workflows/code-review.md#universal-principles).
...
- **Tests exist for the change.** The legacy guide and the [testing-and-qa](../../20-workflows/testing-and-qa.md) page apply: agent-authored tests need the same scrutiny as agent-authored code.
...
- [`../../20-workflows/code-review.md`](../../20-workflows/code-review.md) — universal review framework.
- [`../../10-invariants/agent-era-invariants.md`](../../10-invariants/agent-era-invariants.md#7-no-bypass-of-reviewer-skill-hard-fail-findings) — HARD FAIL semantics; `unsafe` promotes here.
