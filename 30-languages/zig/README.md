...
- [`../../00-operating-model/collaborator-statement.md`](../../00-operating-model/collaborator-statement.md) — no-fabrication invariant: this page exists because the alternative would have been fabricating Zig practice from a vacuum.
