...
Anchors confirmed when the pointer page in `10-invariants/invariance-framework.md` is finalized with [@boorich](https://github.com/boorich).
...
- [`../../10-invariants/invariance-framework.md`](../../10-invariants/invariance-framework.md) — the architectural framework this page defers to.
