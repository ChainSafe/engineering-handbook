...
Language-specific checklist when reviewing a Go PR. Operates under the [universal review principles](../../20-workflows/code-review.md#universal-principles); this page adds the Go-specific surface.
...
- [`../../20-workflows/code-review.md`](../../20-workflows/code-review.md) — the universal review framework.
- [`../../10-invariants/agent-era-invariants.md`](../../10-invariants/agent-era-invariants.md#7-no-bypass-of-reviewer-skill-hard-fail-findings) — HARD FAIL semantics (Go reviewer findings are SOFT WARNING, not HARD FAIL).
