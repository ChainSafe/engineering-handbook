...
Per [agent-era invariant §7](../../10-invariants/agent-era-invariants.md#7-no-bypass-of-reviewer-skill-hard-fail-findings), HARD FAIL bypass requires:
...
- [`../../00-operating-model/gates-and-escalation.md`](../../00-operating-model/gates-and-escalation.md#8-reviewer-skill-hard-fail) — HARD FAIL gate mechanics.
- [`../../10-invariants/agent-era-invariants.md`](../../10-invariants/agent-era-invariants.md#7-no-bypass-of-reviewer-skill-hard-fail-findings).
