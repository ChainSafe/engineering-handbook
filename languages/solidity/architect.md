...
Reviewer skills for Solidity are **HARD FAIL tier** per [reviewer-severity tier table](../../operating-model/gates-and-escalation.md#8-reviewer-skill-hard-fail). Architecture decisions that don't anticipate this will get blocked at review.
