...
Per [reviewer-severity tier table](../../operating-model/gates-and-escalation.md#8-reviewer-skill-hard-fail), TypeScript reviewer findings emit as **SOFT WARNING**. Agent flags, operator decides.
