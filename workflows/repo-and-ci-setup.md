...
Per the [repo-boundaries gate](../operating-model/gates-and-escalation.md#6-repository-and-account-boundaries), the agent operates only on the repo the operator names.
...
- [`../operating-model/gates-and-escalation.md`](../operating-model/gates-and-escalation.md) — the gates relevant when running this checklist as an agent.
