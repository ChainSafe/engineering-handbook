...
The language reviewer pages (`30-languages/<lang>/reviewer.md`) extend this contract with language-specific gate severities. The agent-era invariants ([`../10-invariants/agent-era-invariants.md`](../10-invariants/agent-era-invariants.md)) restate the refusal cases in invariant form.
