...
- [`../10-invariants/agent-era-invariants.md`](../10-invariants/agent-era-invariants.md) — the refusal cases restated as invariants. *(Forthcoming in Phase 2.)*
- [`../30-languages/`](../30-languages/) — language-specific reviewer pages name which HARD FAIL checks apply per language.
